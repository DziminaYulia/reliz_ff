...
function getCardHTML(product) {
  ...
  <div class="card-body">
    ...
    <p class="card-text">${product.price}Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
